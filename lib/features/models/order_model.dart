...
import 'package:yt_ecommerce_admin_panel/features/models/cart_item_model.dart';
...
class OrderModel {
  ...
  factory OrderModel.fromSnapshot(DocumentSnapshot snapshot) {
    ...
    items: data.containsKey('items')
        ? (data['items'] as List<dynamic>).map((item) => CartItemModel.fromJson(item as Map<String, dynamic>)).toList()
        : []
);
  }
